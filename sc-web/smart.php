...
$mail->Username   = 'kekson4eg@mail.ru';                    //SMTP username
$mail->Password   = 'LinPar';                               //SMTP password
// $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
$mail->SMTPSecure = 'ssl';
$mail->Port       = 465;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

//Recipients
$mail->setFrom('kekson4eg@mail.ru', 'scWEB');
$mail->addAddress('izhek645@hotmail.com', 'Evgeny P');     //Add a recipient
